...
void jpeg_encoding_cluster(void *arg) {
    pi_cl_team_fork(pi_cl_cluster_nb_cores(), jpeg_encoder_process, arg);
...
void camera_task(void *parameters) {
    ...
    // Initialize cluster
    struct pi_cluster_conf cluster_conf = {0};
    ...
    pi_cluster_task_t cluster_task = {0};
    cluster_task.entry = jpeg_encoding_cluster;
